...
- `voiceover/section-*.mp3` — five final per-section narration tracks, generated with eSpeak 1.48.15 and FFmpeg.
- `voiceover/clips/` — sentence-level MP3 edit clips for fine-grained assembly.
...
- `scripts/generate_voiceover.py` — deterministic narration generator; emits five section tracks plus sentence-level edit clips.
