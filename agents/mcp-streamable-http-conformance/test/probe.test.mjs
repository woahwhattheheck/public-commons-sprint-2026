...
test('bearer credentials are refused on cleartext HTTP before transmission', async () => {
  await withFixture({ unknownMethodCode: -32010, echoAuthInError: true }, async ({ endpoint, methods, authValues }) => {
